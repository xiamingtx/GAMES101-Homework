...
Eigen::Matrix4f get_model_matrix(float rotation_angle)
{
    ...
    const double theta = DEG2RAD(rotation_angle);
...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio, float zNear, float zFar)
{
    ...
    const double theta = DEG2RAD(eye_fov);
    ...
    Eigen::Matrix4f persp2ortho_matrix, transfer_matrix, scale_matrix;
    // squeeze to a cube
...
int main(int argc, const char **argv)
{
    ...
    if (command_line)
    {
        ...
        std::cout << "succesfully write image at: " << filename << std::endl;
