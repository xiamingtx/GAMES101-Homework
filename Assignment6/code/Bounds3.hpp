                                ...
                                const std::array<int, 3>& dirIsNeg) const
{
    ...
    // if tEnter < tExit -> intersection
    // if tExit < 0 -> The box is "behind" the ray - no intersection
    // if tExit >= 0 and tEnter < 0 -> The ray's origin is inside the box - intersection
